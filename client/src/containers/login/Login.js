    ...
    <div className="object-center">
      <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <a
            href="#"
            className="flex items-center justify-center mt-4 text-gray-600 border rounded-lg dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
